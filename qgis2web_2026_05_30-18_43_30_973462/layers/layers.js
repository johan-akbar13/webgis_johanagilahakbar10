...
//ol.proj.get("EPSG:4326").setExtent([104.996340, -7.005246, 106.237979, -6.170811]);
var wms_layers = [];
...
var lyr_ADMINISTRASIDESA_AR_25K_1 = new ol.layer.Vector({
    ...
    <img src="styles/legend/ADMINISTRASIDESA_AR_25K_1_0.png" /> 0 - 0,00019<br />\
    <img src="styles/legend/ADMINISTRASIDESA_AR_25K_1_1.png" /> 0,00019 - 0,0003<br />\
    <img src="styles/legend/ADMINISTRASIDESA_AR_25K_1_2.png" /> 0,0003 - 0,00045<br />\
    <img src="styles/legend/ADMINISTRASIDESA_AR_25K_1_3.png" /> 0,00045 - 0,00072<br />\
    <img src="styles/legend/ADMINISTRASIDESA_AR_25K_1_4.png" /> 0,00072 - 0,04887<br />' });
...
var lyr_JALAN_LN_25K_3 = new ol.layer.Vector({
    ...
    <img src="styles/legend/JALAN_LN_25K_3_4.png" /> Pematang<br />\
    <img src="styles/legend/JALAN_LN_25K_3_5.png" /> <br />' });
var format_PUSKESMAS_PT_25K_4 = new ol.format.GeoJSON();
var features_PUSKESMAS_PT_25K_4 = format_PUSKESMAS_PT_25K_4.readFeatures(json_PUSKESMAS_PT_25K_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_PUSKESMAS_PT_25K_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PUSKESMAS_PT_25K_4.addFeatures(features_PUSKESMAS_PT_25K_4);
var lyr_PUSKESMAS_PT_25K_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PUSKESMAS_PT_25K_4, 
                style: style_PUSKESMAS_PT_25K_4,
                popuplayertitle: 'PUSKESMAS_PT_25K',
                interactive: true,
                title: '<img src="styles/legend/PUSKESMAS_PT_25K_4.png" /> PUSKESMAS_PT_25K'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_ADMINISTRASIDESA_AR_25K_1.setVisible(true);lyr_ADMINISTRASI_LN_25K_2.setVisible(true);lyr_JALAN_LN_25K_3.setVisible(true);lyr_PUSKESMAS_PT_25K_4.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_ADMINISTRASIDESA_AR_25K_1,lyr_ADMINISTRASI_LN_25K_2,lyr_JALAN_LN_25K_3,lyr_PUSKESMAS_PT_25K_4];
...
lyr_PUSKESMAS_PT_25K_4.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'FCODE': 'FCODE', 'LCODE': 'LCODE', 'SRS_ID': 'SRS_ID', 'REMARK': 'REMARK', 'METADATA': 'METADATA', 'KWKPKM_': 'KWKPKM_', 'KMPPKM_': 'KMPPKM_', 'JPLPKM_': 'JPLPKM_', 'PKMKODE_': 'PKMKODE_', 'PKMKAT_': 'PKMKAT_', 'PKMLMT_': 'PKMLMT_', });
...
lyr_PUSKESMAS_PT_25K_4.set('fieldLabels', {'NAMOBJ': 'no label', 'FCODE': 'no label', 'LCODE': 'no label', 'SRS_ID': 'no label', 'REMARK': 'no label', 'METADATA': 'no label', 'KWKPKM_': 'no label', 'KMPPKM_': 'no label', 'JPLPKM_': 'no label', 'PKMKODE_': 'no label', 'PKMKAT_': 'no label', 'PKMLMT_': 'no label', });
lyr_PUSKESMAS_PT_25K_4.on('precompose', function(evt) {
